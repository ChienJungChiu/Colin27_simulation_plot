...
subject_name_arr={'colin27','KB'}; % the name of the subjects
...
if find_cone_mode==1
    ...
    shift_distance=[37.3]; % in mm, the distance between source and head
    equivalent_r_arr=[22.5]; % in mm
    setting_angle_arr=[30]; % in degree
elseif find_cone_mode==2
    ...
    equivalent_r_arr=[22.5];  % only Cone1
    setting_angle_arr=[30]; % only Cone1
end
